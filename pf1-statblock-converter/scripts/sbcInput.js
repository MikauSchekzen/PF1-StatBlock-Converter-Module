...
export class sbcInputDialog extends Application {
    ...
    static async renderInputDialog() {
        ...
        sbcData.sbcActorType = +sbcConfig.options.defaultActorType
    ...
    activateListeners(html) {
        ...
        /* ActorType Toggle						*/
        /* ------------------------------------ */
        let sbcActorTypeToggle = $(".sbcActorTypeToggle")
        
        // Check if the defaultActorType is pc instead of npc
        if (sbcData.sbcActorType === 1) {
            let sbcActorTypeToggle = $(".sbcActorTypeToggle")
            sbcActorTypeToggle.addClass("createPC")
        }

        sbcActorTypeToggle.on("click", async function() {
            ...
            if (sbcData.sbcActorType === 1) {
                ...
                sbcActorTypeToggle.removeClass("createPC")
                sbcData.characterData.actorData.type = "npc"
            } else {
                sbcData.sbcActorType = 1
                sbcActorTypeToggle.addClass("createPC")
                sbcData.characterData.actorData.type = "character"
            }
